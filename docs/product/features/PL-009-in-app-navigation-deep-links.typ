...
#feature(
  ...
  summary: [
    ...
    application's detail screen, `pipeline://app/{id}?sheet=status` for the same with the Update
    status sheet open, `pipeline://app/new` and `pipeline://app/{id}/edit` for the Add
    and Edit forms, and
