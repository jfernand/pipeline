...
#let shipped-links = ("pipeline://app/{id}", "pipeline://list", "pipeline://app/new", "pipeline://app/{id}/edit", "pipeline://app/{id}?sheet=status", "pipeline://app/{id}?sheet=contact", "pipeline://app/{id}?sheet=delete")
